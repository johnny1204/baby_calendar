            ...
            <section class="p-4">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="text-center m-2.5">
                        <button class="border-solid border border-green-400 bg-green-400 rounded px-10 py-2 text-white font-semibold w-full">ログイン</button>
                    </div>
                    <div class="text-center m-2.5">
                        <button class="border-solid border border-red-400 bg-red-400 rounded px-16 py-4 text-white font-semibold w-full">Googleアカウントでログイン</button>
                    </div>
                    <div class="text-center m-2.5">
                        <button class="border-solid border border-blue-400 bg-blue-400 rounded px-16 py-4 text-white font-semibold w-full">Facebookアカウントでログイン</button>
                    </div>
                </form>
            </section>
        </div>
